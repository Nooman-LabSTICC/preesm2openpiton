...
<dftools:workflow errorOnWarning="true" verboseLevel="INFO" xmlns:dftools="http://net.sf.dftools">
    ...
    <dftools:task
        pluginId="org.ietr.preesm.memory.script.MemoryScriptTask" taskId="MemScript">
        <dftools:data key="variables">
    ...
    <dftools:dataTransfer from="PiSDF Scheduling"
        sourceport="DAG" targetport="DAG" to="MemScript"/>
    <dftools:dataTransfer from="scenario" sourceport="scenario"
        targetport="scenario" to="MemScript"/>
    <dftools:dataTransfer from="MEG Builder" sourceport="MemEx"
        targetport="MemEx" to="MemScript"/>
    <dftools:dataTransfer from="MemScript" sourceport="MemEx"
