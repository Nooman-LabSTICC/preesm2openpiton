...
//		pthread_barrier_wait(&iter_barrier);
		...
		receiveStart(); // Core1 > Core8: Stabilization_0_ComputeBlock__9
		// SyncComGroup = 0
		receiveEnd(1, 8); // Core1 > Core8: Stabilization_0_ComputeBlock__9
		receiveStart(); // Core1 > Core8: Stabilization_0_ComputeBlock__24
		// SyncComGroup = 0
		receiveEnd(1, 8); // Core1 > Core8: Stabilization_0_ComputeBlock__24
		receiveStart(); // Core0 > Core8: Stabilization_0_ComputeBlock__142
		// SyncComGroup = 0
		receiveEnd(0, 8); // Core0 > Core8: Stabilization_0_ComputeBlock__142
		receiveStart(); // Core0 > Core8: Stabilization_0_ComputeBlock__158
		// SyncComGroup = 0
		receiveEnd(0, 8); // Core0 > Core8: Stabilization_0_ComputeBlock__158
		receiveStart(); // Core1 > Core8: Stabilization_0_ComputeBlock__40
		// SyncComGroup = 0
		receiveEnd(1, 8); // Core1 > Core8: Stabilization_0_ComputeBlock__40
		receiveStart(); // Core1 > Core8: Stabilization_0_ComputeBlock__56
		// SyncComGroup = 0
		receiveEnd(1, 8); // Core1 > Core8: Stabilization_0_ComputeBlock__56
		receiveStart(); // Core1 > Core8: Stabilization_0_ComputeBlock__75
		// SyncComGroup = 0
		receiveEnd(1, 8); // Core1 > Core8: Stabilization_0_ComputeBlock__75
		receiveStart(); // Core1 > Core8: Stabilization_0_ComputeBlock__91
		// SyncComGroup = 0
		receiveEnd(1, 8); // Core1 > Core8: Stabilization_0_ComputeBlock__91
		...
		// SyncComGroup = 1
		sendStart(8, 0); // Core8 > Core0: Stabilization_0_ComputeBlock__224
		sendEnd(); // Core8 > Core0: Stabilization_0_ComputeBlock__224
		receiveStart(); // Core0 > Core8: Stabilization_0_ComputeBlock__174
		// SyncComGroup = 2
		receiveEnd(0, 8); // Core0 > Core8: Stabilization_0_ComputeBlock__174
		receiveStart(); // Core1 > Core8: Stabilization_0_ComputeBlock__107
		// SyncComGroup = 2
		receiveEnd(1, 8); // Core1 > Core8: Stabilization_0_ComputeBlock__107
		...
		// SyncComGroup = 3
		sendStart(8, 0); // Core8 > Core0: Stabilization_0_ComputeBlock__240
		sendEnd(); // Core8 > Core0: Stabilization_0_ComputeBlock__240
		receiveStart(); // Core0 > Core8: Stabilization_0_ComputeBlock__190
		// SyncComGroup = 4
		receiveEnd(0, 8); // Core0 > Core8: Stabilization_0_ComputeBlock__190
		receiveStart(); // Core1 > Core8: Stabilization_0_ComputeBlock__123
		// SyncComGroup = 4
		receiveEnd(1, 8); // Core1 > Core8: Stabilization_0_ComputeBlock__123
		...
		// SyncComGroup = 5
		sendStart(8, 0); // Core8 > Core0: Stabilization_0_ComputeBlock__256
		sendEnd(); // Core8 > Core0: Stabilization_0_ComputeBlock__256
		...
		// SyncComGroup = 6
		sendStart(8, 0); // Core8 > Core0: Stabilization_0_ComputeBlock__208
		sendEnd(); // Core8 > Core0: Stabilization_0_ComputeBlock__208
	}
	return NULL;
}
