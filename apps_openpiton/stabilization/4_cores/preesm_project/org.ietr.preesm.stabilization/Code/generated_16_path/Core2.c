...
//		pthread_barrier_wait(&iter_barrier);
		...
		receiveStart(); // Core0 > Core2: Stabilization_0_ComputeBlock__152
		// SyncComGroup = 0
		receiveEnd(0, 2); // Core0 > Core2: Stabilization_0_ComputeBlock__152
		...
		receiveStart(); // Core1 > Core2: Stabilization_0_ComputeBlock__85
		// SyncComGroup = 0
		receiveEnd(1, 2); // Core1 > Core2: Stabilization_0_ComputeBlock__85
		...
		receiveStart(); // Core0 > Core2: Stabilization_0_ComputeBlock__184
		// SyncComGroup = 5
		receiveEnd(0, 2); // Core0 > Core2: Stabilization_0_ComputeBlock__184
