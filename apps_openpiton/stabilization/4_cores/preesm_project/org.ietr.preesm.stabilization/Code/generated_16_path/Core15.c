...
//		pthread_barrier_wait(&iter_barrier);
		...
		receiveStart(); // Core1 > Core15: Stabilization_0_ComputeBlock__30
		// SyncComGroup = 0
		receiveEnd(1, 15); // Core1 > Core15: Stabilization_0_ComputeBlock__30
		receiveStart(); // Core1 > Core15: Stabilization_0_ComputeBlock__46
		// SyncComGroup = 0
		receiveEnd(1, 15); // Core1 > Core15: Stabilization_0_ComputeBlock__46
		receiveStart(); // Core1 > Core15: Stabilization_0_ComputeBlock__62
		// SyncComGroup = 0
		receiveEnd(1, 15); // Core1 > Core15: Stabilization_0_ComputeBlock__62
		...
		receiveStart(); // Core0 > Core15: Stabilization_0_ComputeBlock__164
		// SyncComGroup = 2
		receiveEnd(0, 15); // Core0 > Core15: Stabilization_0_ComputeBlock__164
		receiveStart(); // Core1 > Core15: Stabilization_0_ComputeBlock__97
		// SyncComGroup = 2
		receiveEnd(1, 15); // Core1 > Core15: Stabilization_0_ComputeBlock__97
		...
		// SyncComGroup = 3
		sendStart(15, 0); // Core15 > Core0: Stabilization_0_ComputeBlock__230
		sendEnd(); // Core15 > Core0: Stabilization_0_ComputeBlock__230
		...
		receiveStart(); // Core0 > Core15: Stabilization_0_ComputeBlock__196
		// SyncComGroup = 6
		receiveEnd(0, 15); // Core0 > Core15: Stabilization_0_ComputeBlock__196
		receiveStart(); // Core1 > Core15: Stabilization_0_ComputeBlock__129
		// SyncComGroup = 6
		receiveEnd(1, 15); // Core1 > Core15: Stabilization_0_ComputeBlock__129
		...
		// SyncComGroup = 7
		sendStart(15, 0); // Core15 > Core0: Stabilization_0_ComputeBlock__262
		sendEnd(); // Core15 > Core0: Stabilization_0_ComputeBlock__262
	}
	return NULL;
}
